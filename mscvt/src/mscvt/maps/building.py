from building_creation import building_creation  # Correct import
...
class Building:
    def __init__(self, building_name, building_type):
        ...
        self.bui = BuildingCreation(building_type, building_name)  # Correct instantiation
        self.residents = []
        self.auth_meetings = {}
    ...
    def create_authorized_persons(self, resident_id):
        ...
        authorized_persons = [f"{resident_id} -> P00{i}" for i in range(1, 4)]  # P001, P002, P003
