...
def main():
    ...
    visitor_node_3 = Visitor_Node(
        ID='Bandit', host=visitors['host'][9], host_location=visitors['host_location'][1], marker_id=3, meeting_time=5)
    visitor_node_4 = Visitor_Node(
        ID=visitors['id'][1], host=visitors['host'][15], host_location=visitors['host_location'][15], marker_id=4, meeting_time=5)
