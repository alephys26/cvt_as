...
def main():
    ...
    visitor_node_1 = Visitor_Node(
        ID=visitors['id'][indices[0]], host=visitors['host'][indices[0]], host_location=visitors['host_location'][indices[0]], marker_id=1, meeting_time=visitors['meeting_time'][indices[0]])
    visitor_node_2 = Visitor_Node(
        ID=visitors['id'][indices[1]], host=visitors['host'][indices[1]], host_location=visitors['host_location'][indices[1]], marker_id=2, meeting_time=visitors['meeting_time'][indices[1]])
    visitor_node_3 = Visitor_Node(
        ID=visitors['id'][indices[2]], host=visitors['host'][indices[2]], host_location=visitors['host_location'][indices[2]], marker_id=3, meeting_time=visitors['meeting_time'][indices[2]])
    visitor_node_4 = Visitor_Node(
        ID='Bandit', host=visitors['host'][9], host_location=visitors['host_location'][1], marker_id=4, meeting_time=5)
    visitor_node_5 = Visitor_Node(
        ID=visitors['id'][1], host=visitors['host'][15], host_location=visitors['host_location'][15], marker_id=5, meeting_time=5)
